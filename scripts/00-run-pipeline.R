...
source(here::here("scripts", "05-backfill-crime-nibrs.R"))
source(here::here("scripts", "06-build-spatial.R"))
source(here::here("scripts", "07-prep-dashboard.R"))
source(here::here("scripts", "08-prep-period-comparison.R"))
source(here::here("scripts", "09-join-demographics.R"))
source(here::here("scripts", "10-yearly-counts.R"))
